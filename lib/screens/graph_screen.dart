...
class _GraphScreenState extends State<GraphScreen> {
  ...
  Future<void> _loadScores() async {
    final Map<DateTime, int> storedMap =
        await EmotionStorage.loadEmotionScoreMap();
        ...
        child: Padding(
          ...
          child:
              spots.every((spot) => spot.y == 0)
                  ? Center(child: Text('선택한 날짜 내 작성된 일기가 없어요!'))
                  : LineChart(
                    LineChartData(
                      minX: 0,
                      maxX:
                          spots.length > 0 ? (spots.length - 1).toDouble() : 0,
                      minY: 0.5,
                      maxY: 5.5,
                      ...
                      lineTouchData: LineTouchData(
                        touchTooltipData: LineTouchTooltipData(
                          getTooltipColor:
                              (LineBarSpot touchedSpot) => Colors.transparent,
                      ...
                      lineBarsData: [
                        LineChartBarData(
                          ...
                          gradient: LinearGradient(
                            colors: [Color(0xFF689F38), Color(0xFFE6F8D5)],
                          ...
                          belowBarData: BarAreaData(
                            ...
                            gradient: LinearGradient(
                              colors: [
                                Color(0xFF689F38).withOpacity(0.3),
                                Color(0xFFE6F8D5).withOpacity(0.1),
                              ],
